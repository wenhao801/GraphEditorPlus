...
struct qt_meta_stringdata_CLASSMySceneENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMySceneENDCLASS = QtMocHelpers::stringData(
    "MyScene"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMySceneENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MyScene::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMySceneENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMySceneENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMySceneENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *MyScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMySceneENDCLASS.stringdata0))
